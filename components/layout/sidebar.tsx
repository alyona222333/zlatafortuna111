...
import {
  ...
  Store, LayoutGrid, ListTree, GitBranch, Tag, Link2, BookOpen,
} from 'lucide-react'
...
export function Sidebar({ businessName, allowedSections, isOwnerOrDirector = true, role = null }: SidebarProps) {
  ...
  const allGroups: { label: string; items: { href: string; label: string; icon: typeof LayoutDashboard; section: SidebarSection; ownerOnly?: boolean }[] }[] = [
    ...
    { label: t('groupWorkspace'), items: [
      { href: '/workspace', label: t('workspace'), icon: MessageCircle, section: 'workspace' },
      { href: '/instructions', label: t('instructions'), icon: BookOpen, section: 'instructions' },
    ]},
    ...
    { label: t('groupWarehouse'), items: [
      ...
      { href: '/inventory/transfer', label: t('inventoryTransfer'), icon: ArrowLeftRight, section: 'inventory_transfer' },
      { href: '/inventory/stocktaking', label: t('inventoryStocktaking'), icon: ListTree, section: 'inventory_stocktaking' },
    ]},
    { label: t('groupSuppliers'), items: [
      { href: '/suppliers', label: t('suppliers'), icon: Link2, section: 'suppliers' },
      { href: '/inventory/purchase', label: t('inventoryPurchase'), icon: PackagePlus, section: 'suppliers', ownerOnly: true },
    ]},
