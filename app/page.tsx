...
export const metadata: Metadata = {
  title: 'Zlata Fortuna Group — CRM, каса, склад та запис для бізнесу',
  description:
    'Zlata Fortuna Group CRM — каса, клієнти, склад, запис та інтеграції для малого й середнього бізнесу. Без комісій.',
  keywords: [
    'open source POS',
    'self-hosted CRM',
  ...
  alternates: {
    canonical: 'https://zlatafortuna.com.ua/',
  },
  openGraph: {
    type: 'website',
    url: 'https://zlatafortuna.com.ua/',
    title: 'Zlata Fortuna Group — CRM для бізнесу',
    description:
      'Self-hosted POS, CRM, Booking and Omnichannel notifications. Zero commission. One command install.',
    images: [{ url: 'https://zlatafortuna.com.ua/og-image.png' }],
    locale: 'en_US',
    siteName: 'Zlata Fortuna Group',
  },
  twitter: {
    ...
    description:
      'Self-hosted POS, CRM, Booking and Omnichannel notifications. Zero commission. One command install.',
    images: ['https://zlatafortuna.com.ua/og-image.png'],
  },
}
...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Скільки коштує CRM Zlata Fortuna Group?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Чи є комісія за замовлення?',
  ...
  return (
    <div className={`${styles.page} ${bricolage.variable} ${dmSans.variable}`}>
      ...
      <section className={styles.faq}>
        <div className={styles.faqInner}>
          ...
          <div className={styles.faqItem}>
            <div className={styles.faqQ}>Скільки коштує CRM Zlata Fortuna Group?</div>
          ...
          <div className={styles.faqItem}>
            <div className={styles.faqQ}>Чи є комісія за замовлення?</div>
            <div className={styles.faqA}>
          ...
          <div className={styles.faqItem}>
            <div className={styles.faqQ}>Для яких типів бізнесу підходить?</div>
            <div className={styles.faqA}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerCopy}>© 2026 Zlata Fortuna Group. All rights reserved.</div>
