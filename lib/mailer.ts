 ...
 *  "Zlata Fortuna Group <noreply@...>" → "Your Business <noreply@...>"
 */
export function getFromAddress(businessName?: string): string {
  const base = process.env.RESEND_FROM_EMAIL ?? process.env.SMTP_FROM ?? 'Zlata Fortuna Group <noreply@zlatafortuna.com.ua>'
